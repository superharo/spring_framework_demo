package online.superh.springtask.job;
...
public class DemoJob {
     ...
     * 这三个属性，有点雷同，可以看看 《@Scheduled 定时任务的 fixedRate、fixedDelay、cron 的区别》 ，一定要分清楚差异。
     * 不常用属性如下：
